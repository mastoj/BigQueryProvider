...
<div class="row">
  ...
  <div class="span6">
    <div class="well well-small" id="nuget">
      The BigQueryProvider library can be <a href="https://nuget.org/packages/BigQueryProvider">installed from NuGet</a>:
      <pre>PM> Install-Package BigQueryProvider</pre>
    </div>
  </div>
  <div class="span1"></div>
</div>
