...
#r "../../src/BigQueryProvider/bin/Release/BigQueryProvider.Runtime.dll"
#r "../../src/BigQueryProvider/bin/Release/BigQueryProvider.DesignTime.dll"
...
let query = """SELECT * FROM `bigquery-public-data.samples.shakespeare` LIMIT 1000"""
...
let res2 = executeQuery query

let schema =
    query
    |> BigQueryHelper.analyzeQueryRaw
    |> (fun x -> printfn "Something: %A" x; x)
